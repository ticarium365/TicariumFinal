...
router.use("/firma-profili", requireAuth, firmaProfiliRouter);
router.use("/kurulum-skoru", requireAuth, kurulumSkoruRouter);
router.use("/onboarding", requireAuth, onboardingRouter);
router.use("/product-analytics", requireAuth, productAnalyticsRouter);
...
router.use("/finance-documents", requireAuth, financeDocumentsRouter);
...
router.use("/catalog-settings", requireAuth, catalogSettingsRouter);
router.use("/order-analytics", requireAuth, orderAnalyticsRouter);
router.use("/orders-manage", requireAuth, ordersManageRouter);
router.use("/customer-groups", requireAuth, customerGroupsRouter);
