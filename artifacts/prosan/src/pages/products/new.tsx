...
import { useCreateProduct, useGenerateBarcode } from "@workspace/api-client-react";
          ...
          <CardContent className="space-y-6">
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="salePrice" name="salePrice" type="number" min="0" step="0.01" value={formData.salePrice} onChange={handleChange} required className="font-bold text-primary border-primary/50" />
              </div>
            </div>
