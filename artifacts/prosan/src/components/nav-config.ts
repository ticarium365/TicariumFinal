...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    icon: Wallet,
    items: [
      { href: "/finance", label: "Kasa & Giderler", icon: Wallet, roles: ["admin", "staff", "viewer"], feature: "finance.expenses" },
      { href: "/banking", label: "Banka Hareketleri", icon: Banknote, roles: ["admin", "staff"], feature: "finance.banking" },
      { href: "/finance-dashboard", label: "Finans Özeti", icon: PieChart, roles: ["admin", "viewer"], feature: "profit.dashboard" },
      { href: "/profit", label: "Kârlılık", icon: TrendingUp, roles: ["admin", "staff", "viewer"], feature: "profit.dashboard" },
      { href: "/gercek-kar", label: "Gerçek Kâr Analizi", icon: Calculator, roles: ["admin", "viewer"], feature: "profit.true_dashboard" },
      ...
      { href: "/documents", label: "Evrak Arşivi", icon: FileText, roles: ["admin", "staff", "viewer"], feature: "documents" },
      { href: "/doviz", label: "Döviz & Çoklu Para", icon: DollarSign, roles: ["admin", "staff", "viewer"], feature: "currency.multi" },
    ],
  },
  {
    id: "online",
    ...
    icon: Store,
    items: [
      { href: "/eticarium-merkezi", label: "Online Satış Merkezi", icon: Sparkles, roles: ["admin", "staff", "viewer"], feature: "marketplace.basic" },
      { href: "/marketplace", label: "Pazaryeri Siparişleri", icon: Radio, roles: ["admin", "staff"], feature: "marketplace.basic" },
      ...
      { href: "/network", label: "B2B İş Ortakları", icon: Network, roles: ["admin", "staff", "viewer"], feature: "marketplace.pro" },
      { href: "/kargo", label: "Kargo Ayarları", icon: Truck, roles: ["admin", "staff", "viewer"], feature: "marketplace.basic" },
    ],
  },
  {
    id: "raporlar",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/kurulum-skoru", label: "Kurulum İlerlemesi", icon: Target, roles: ["admin"] },
      { href: "/settings", label: "Marka & Logo", icon: Settings, roles: ["admin"] },
      { href: "/entegrasyonlar", label: "Bağlantılar (Entegrasyon)", icon: Webhook, roles: ["admin", "staff", "viewer"] },
